...
describe('Proficiencies', () => {
    ...
    test('renders the correct proficiency bonus', () => {
        ...
        const acrobaticsProfBonus = screen.getByTestId(
        ...
        const athleticsProfBonus = screen.getByTestId(
            'Athletics-switch-proficiency-bonus'
        );
    ...
    test('calls switch onChange function', () => {
        ...
        expect(mockProficiencesProps.onSwitchChange).toHaveBeenCalledWith(
            'Acrobatics'
        );
    });
